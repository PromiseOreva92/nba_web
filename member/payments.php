                ...
                <div class="col-sm-10" id="content">
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-3" style="margin-left:10px;">
                            <div class="row" style="border:1px solid #ccc;border-radius:10px;margin-top: 20px;padding:10px;background:#fff;">
                                <div class="col-sm-4" style="text-align: center;padding:10px 0px;background:#28A745;border-radius:5px">
                                    <span class="fa fa-bank" style="font-size:3.5em;color:#fff;"></span>
                                </div> 
                                <div class="col-sm-8">
                                    <h5><strong>Pay Branch Dues</strong></h5>
                                    <a href="branch_dues.php" class="links">Pay Now</a>
                                </div>
                            </div>
                        </div>
                        <div class="col-sm-1"></div>
                        <div class="col-sm-3">
                            <div class="row" style="border:1px solid #ccc;border-radius:10px;margin-top: 20px;padding:10px;background:#fff;">
                                ...
                                <div class="col-sm-8">
                                    <h5><strong>Register For Law Week</strong></h5>
                                    <a href="#" class="links">Pay Now</a>
                                </div>
                            </div>
                        </div>  
                        ...
                        <div class="col-sm-3">
                            <div class="row" style="border:1px solid #ccc;border-radius:10px;margin-top: 20px;padding:10px;background:#fff;">
                                <div class="col-sm-4" style="text-align: center;padding:10px 0px;background: #0056b3;border-radius:5px">
                                    <span class="fa fa-legal" style="font-size:3.5em;color:#fff;"></span>
                                </div> 
                                <div class="col-sm-8">
                                    <h5><strong>Annual Law Dinner</strong></h5>
                                    <a href="#" class="links">Pay Now</a>
                                </div>
                            </div>
                        </div> 
                    ...
                    <div class="row" style="background:#fff;margin:10px;border:1px solid #ccc;">
                        <div class="col-sm-12" style="margin-top:10px;">
                            ...
                            <p style="color:#DC3545; font-size: 16px;font-weight:200;">There are no payment notifications</p>
                        </div> 
                    </div>
                </div>
            </div>
